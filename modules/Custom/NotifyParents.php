...
if($_REQUEST['modfunc']=='save')
{
	...
	ListOutput($RESULT,$columns,_('Notification Result'),_('Notification Results'));
	}
	else
...
if(!$_REQUEST['modfunc'] || $_REQUEST['modfunc']=='list')
{
	if($_REQUEST['modfunc']=='list')
	{
		...
		DrawHeader('',SubmitButton(_('Notify Selected Parents')));
	}
	...
	if($_REQUEST['modfunc']=='list')
	{
		echo '<BR><CENTER>'.SubmitButton(_('Notify Selected Parents')).'</CENTER>';
		echo "</FORM>";
	}
}
