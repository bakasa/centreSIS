...
ListOutput($LO_types,$types_columns,_('Transaction Type'),_('Transaction Types'),false,$types_group,array('save'=>false,'search'=>false,'print'=>false));

ListOutput($RET,$columns,_('Transaction'),_('Transactions'),$link,$group,array('save'=>false,'search'=>false,'print'=>false));
}
