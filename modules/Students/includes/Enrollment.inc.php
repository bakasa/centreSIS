...
if($_REQUEST['student_id']!='new')
{
	...
	ListOutput($RET,$columns,_('Enrollment Record'),_('Enrollment Records'),$link,array(),array('save'=>false,'search'=>false));
	if($id!='new')
...
{
	$id = 'new';
	ListOutput($RET,$columns,_('Enrollment Record'),_('Enrollment Records'),$link,array(),array('count'=>false));
